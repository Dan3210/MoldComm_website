...
<head>
    ...
    <title>Housing - Moldovan Community USA</title>
    <style>
        :root {
...
<body>
    ...
    <main>
        <div class="posts-container">
            <?php if (empty($posts)): ?>
                <div class="no-posts">
                    <h2>No housing listings available</h2>
                    <p>Be the first to post a housing listing!</p>
                </div>
            <?php else: ?>
        ...
        <?php if ($auth->isLoggedIn()): ?>
            <a href="create-post.php" class="btn btn-post">Post Housing</a>
        <?php else: ?>
            <a href="login.php" class="btn btn-post">Login to Post</a>
        <?php endif; ?>
    </main>
